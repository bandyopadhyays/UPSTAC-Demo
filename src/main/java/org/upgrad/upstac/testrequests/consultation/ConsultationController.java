...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        //Implement this method to get the list of test requests
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        //Implement this method to return the list of test requests
        // assigned to current doctor(make use of the above created User object)
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        // Create an object of TestRequest class and use the
        // assignForConsultation() method of testRequestUpdateService to assign the particular id to the current user
